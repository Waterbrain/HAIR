        ...
        `}_renderExpanded(e){return F`
            <div class="expanded">
                ...
                <div class="signal-list">
                    ${e.signals.map(t=>{const i=this._recentFingerprints.indexOf(t.fingerprint),s=0===i,a=1===i,o=this._glowFingerprints.has(t.fingerprint),n=this._hitFlashFingerprints.has(t.fingerprint);return F`
                            <div class="signal-row">
                                <div class="signal-info">
                                    ${t.sl_pattern?F`<span class="diamonds">${[...t.sl_pattern].map(e=>"L"===e?F`<span class="diamond long">◆</span>`:F`<span class="diamond short">◇</span>`)}</span>`:F`<code class="signal-code">${t.protocol??"RAW"}: ${t.code??`${t.raw_timings.length} timings`}</code>`}
                                </div>
